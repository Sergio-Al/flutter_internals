...
// import 'package:internal_flutter/keys/todo_item.dart';
import 'package:internal_flutter/keys/checkable_todo_item.dart';
          ...
          child: Column(
            children: [
              ...
              for (final todo in _orderedTodos)
                CheckableTodoItem(
                  key: ObjectKey(todo), // ValueKey() is more lightweight
                  todo.text,
                  todo.priority,
                ),
            ],
